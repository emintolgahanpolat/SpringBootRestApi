...
import com.emintolgahanpolat.api.service.TopicService;
...
@RestController
@RequestMapping(value = "/topics", produces = {MediaType.APPLICATION_JSON_VALUE,MediaType.APPLICATION_XML_VALUE})
